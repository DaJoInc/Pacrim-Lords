...
export class ConfigService {
  ...
  private _get_contries = this._api_url + '/pais/lista';
  
  private _get_state = this._api_url + '/pais/departamento/lista';
  
    private _get_cities = this._api_url + '/pais/departamento/ciudad/lista';
  ...
  get get_contries():string {
      return this._get_contries;
  }
  ...
  get get_cities():string {
      return this._get_cities;
  }
