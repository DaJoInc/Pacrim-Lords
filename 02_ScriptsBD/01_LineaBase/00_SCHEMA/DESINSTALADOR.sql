...
set feedback on
	...
	DROP TABLE   "FS_PCRM_US"."NE_TSTNE" CASCADE CONSTRAINTS;
	...
	DROP TABLE   "FS_PCRM_US"."US_TRLNE" CASCADE CONSTRAINTS;
    
    DROP TABLE   "FS_PCRM_US"."US_TPSNE" CASCADE CONSTRAINTS;
    
    DROP TABLE   "FS_PCRM_US"."US_TPUSR" CASCADE CONSTRAINTS;
       ...
       DROP SEQUENCE "FS_PCRM_US"."SNE_TTPPV";
        DROP SEQUENCE "FS_PCRM_US"."SNE_TTRPR";
         DROP SEQUENCE "FS_PCRM_US"."SNE_TTSTC";
          ...
          DROP SEQUENCE "FS_PCRM_US"."SEUS_TRLNE"; 
           DROP SEQUENCE "FS_PCRM_US"."US_TPUSR"; 
    DROP SEQUENCE "FS_PCRM_US"."SEUS_TRLNE"; 
    REM USUARIO  DUENHO DEL APLICATIVO FS_PCRM_US
drop user FS_PCRM_US cascade;

REM TABLESPACE DE DATOS
DROP TABLESPACE TS_TPACRIM   INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;
/

REM TABLESPACE DE INDICES 
DROP TABLESPACE TS_PACRIM INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;
/

REM TABLESPACE TEMPORAL
DROP tablespace TS_IPACRIM INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;
/
