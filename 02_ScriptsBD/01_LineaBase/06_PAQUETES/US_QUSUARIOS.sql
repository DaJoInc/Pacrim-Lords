prompt
prompt PACKAGE: EM_QrusuarioS
prompt
CREATE OR REPLACE PACKAGE FS_PCRM_US.EM_QrusuarioS IS
    --
    -- ===========================================================
    -- EM_QrusuarioS
    -- -----------------------------------------------------------
...
prompt
prompt PACKAGE BODY:EM_QrusuarioS
prompt

CREATE OR REPLACE PACKAGE BODY FS_PCRM_US.EM_QrusuarioS IS
